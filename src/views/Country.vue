                    ...
                    >
                        ...
                        >
                            <router-link
                                :to="{
                                    name: 'Country',
                                    params: { name: country.alpha3Code },
                                }"
                            >
                                <span>{{
                                    country.name | limitCharacters(20)
                                }}</span>
                            </router-link>
                        </div>
                    </div>
...
export default {
    ...
    computed: {
        ...
        currenciesToString() {
            ...
            if (
                this.country.currencies !== undefined &&
                this.country.currencies.length > 0
            ) {
                ...
                currenciesString = 'Not currencies found';
            }
        ...
        borderCountries() {
            ...
            if (
                borderCountriesCodes !== undefined &&
                borderCountriesCodes.length >= 1
            ) {
                borderCountriesCodes.forEach((countryCode) => {
                    const { name, alpha3Code } =
                        this.$store.getters.country(countryCode);
